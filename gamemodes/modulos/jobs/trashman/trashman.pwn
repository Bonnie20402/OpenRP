...
public TrashManInit() {
    ...
    // Job vehicles
    gTrashman_VEHICLES[0][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,2191.9988,-1997.5925,13.5469,3.2291,1,1,240,0);
    gTrashman_VEHICLES[1][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,2192.5149,-1988.7640,13.5469,356.6490,1,1,240,0);
    gTrashman_VEHICLES[2][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,21187.7561,-1988.0947,13.5469,356.6490,1,1,240,0);
    gTrashman_VEHICLES[3][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,2188.2925,-1994.8071,13.5469,355.7091,1,1,240,0);
    gTrashman_VEHICLES[4][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,2183.9297,-1992.7301,13.5469,350.6957,1,1,240,0);
    gTrashman_VEHICLES[5][TRASHMANVEHICLE_VEHICLEID]=AddStaticVehicleEx(408,2185.0142,-1986.1168,13.5505,350.6957,1,1,240,0);

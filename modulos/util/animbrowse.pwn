...
YCMD:animhelp(playerid, params[],help) {
...
YCMD:animbrowse(playerid, params[],help) {
...
YCMD:deletealltextdraws(playerid, params[],help) {
	for(new i; i < 2048; i++) {

...
/*
	Updates an item	by passing the row and column. UNSAFE: No out of bounds check!
						*/
forward InvGUI:InventoryRenderUpdateItem(playerid,row,column,newModel,String:title[],String:quantity[]);
public InvGUI:InventoryRenderUpdateItem(playerid,row,column,newModel,String:title[],String:quantity[]) {
...
/*
	...
	*/
forward InvGUI:InventoryRenderUpdateItemEx(playerid, index,newModel, String:title[], String:quantity[]);
public InvGUI:InventoryRenderUpdateItemEx(playerid, index,newModel, String:title[], String:quantity[]) {
...
hook OnPlayerClickPlayerTD(playerid, PlayerText:playertextid) {
	...
	if(playertextid==INVALID_TEXT_DRAW && IsPlayerInvOpen(playerid))CloseInventory(playerid);
	return 1;
}
